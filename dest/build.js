...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueMaterial = __webpack_require__(2);
	 ...
	 * Vue Componentを定義する
	 */
	var sidenav = __webpack_require__(7);
	_vue2.default.component('tm-sidenav', _vue2.default.extend(sidenav));
	
	var app = new _vue2.default().$mount('#app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/kondo-shun/timer/src/component/sidenav/sidenav.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-1144fff1", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-1144fff1", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] sidenav.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  ...
	  }, [_h('md-toolbar', [_h('md-button', {
	    staticClass: "md-icon-button",
	    on: {
	      "click": toggleLeftSidenav
	    }
	  }, [_h('md-icon', ["menu"])]), " ", _m(0)]), " ", _h('md-sidenav', {
	    ref: "leftSidenav",
	    staticClass: "md-left",
	    on: {
	      "open": function($event) {
	  ...
	  return _h('p', ["Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi cupiditate esse necessitatibus beatae nobis, deserunt ut est fugit, tempora deleniti, eligendi commodi doloribus. Nemo, assumenda possimus, impedit inventore perferendis iusto!"])
	}}]}
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-1144fff1", module.exports)
	  }
	}
